...
5. Для запуска приложения выполните:
    ...
    .. note::
       ...
       Для настройки параметров запуска следует передать консольной команде аргументы в соответствии с её документацией:
        ...
        Для выбора стиля цитирования используется параметр `--citation`, который принимает следующие значения:

        - `gost`: оформление в стиле ГОСТ Р 7.0.5-2008
        - `mla`: оформление в стиле MLA 9
        - `apa`: оформление в стиле APA 7
...
Форматирование по APA
=====================

.. automodule:: formatters.styles.apa
    :members:

Форматирование по MLA
=====================

.. automodule:: formatters.styles.mla
    :members: